...
Repo-wide subjects — env vars, CI, `@packages/contracts`, **fin applet naming** — are indexed
in [`../../AGENTS.md`](../../AGENTS.md). Financial UI lives under `src/features/fin/` per
[`../../refs/monorepo-fin-applet.md`](../../refs/monorepo-fin-applet.md).
